...
Replace `YOUR_SERVER_IP` with your VPS or server IP address.
...
> Note: this image is built locally with `docker build`, so there's no `docker pull` step unless you push it to a registry yourself first.
...
<div align="center">
  <img src="screenshot.png" alt="Ubuntu Desktop Screenshot" width="850">
</div>
...
[![Telegram](https://img.shields.io/badge/Telegram-Dev__Null__X__NODE__JS-229ED9?style=for-the-badge&logo=telegram&logoColor=white)](https://t.me/Dev_Null_X_NODE_JS)
...
<img src="https://capsule-render.vercel.app/api?type=waving&color=00D9A5&height=120&section=footer&text=DEV_NULL_X&fontSize=32&fontColor=000000&animation=twinkling">
